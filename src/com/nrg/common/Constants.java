 ...
 * */
public static String MC_PROFESSIONAL_QUOTE = "mpq";
public static String MC_PROFESSIONAL_ACCEPTQUOTE="mpa";
...
public static double HP_PUMPTYPE_CHARGES=1000;
public static double HP_PERCAPACITY_CHARGES=10;

public static double GD_PERAREA_CHARGES=15;
public static double GD_GREENHOUSE_CHARGES=2500;
public static double GD_DRIP_CHARGES=50;
